    ...
    const template = `
        <modal :close="close" class="no-header">                                        
            <template v-slot:content>
                ...
                <p>{{ui.dictionary.accounts.automapFailure}}</p>
            ...
            <template v-slot:footer>
                <div class="buttons-container zero-padding-top zero-padding-bottom">
                    <div class="zero-padding"><a href="" v-on:click.prevent="close()">{{ui.dictionary.accounts.mapManually}}</a></div>
