/* global localStorage */
/**
 * A CRRUD wrapper around localStorage.
 * 
...
define([
    ...
    return {
        ...
        create : function(key, value) {
            ...
            d.resolve( genereateDataResponse(true, localStorage.setItem(key, value)) );
        ...
        retrieve : function(key) {
            ...
            d.resolve( genereateDataResponse(true, localStorage.getItem(key)) );
            return d.promise;
        },
        ...
        update : function(key, value) {
            ...
            //Type mismatch
            if (typeof JSON.parse(localStorage.getItem(key)) !== typeof value) {
            ...
            if (typeof value == 'object') {
                var originalObject = JSON.parse(localStorage.getItem(key));
